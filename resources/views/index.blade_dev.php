...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>스타크래프트 빨무 커뮤니티 - 3040 CLAN</title>
        ...
        <div class="container-fluid nav-bar sticky-top px-4 py-2 py-lg-0">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="#" class="btn btn-primary rounded-pill py-2 px-4 flex-shrink-0">로그인/회원가입</a>
                </div>
            </nav>
        </div>
        <!-- Navbar & Hero End -->
                ...
                <div class="row g-4">
                        ...
                        <div class="feature-item">
                            ...
                            <div class="feature-content p-4">
                                <div class="feature-content-inner">
                                    <h4 class="text-white">운영진 소개</h4>
                                    <p class="text-white">마스터 : SkaN </p>
                                    <p class="text-white">관리자 : goah, daebang, ook, wons </p>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="feature-item">
                            ...
                            <div class="feature-content p-4">
                                <div class="feature-content-inner">
                                    <h4 class="text-white">대회정보</h4>
                                    <p class="text-white">☆☆큰욱님 후원 3대3 대회☆☆ 24.7.14～24.7.28 상픽, 하픽 결승전 예정
                                    </p>
                                    <a href="#" class="btn btn-primary rounded-pill py-2 px-4">Read More <i class="fa fa-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="feature-item">
                            ...
                            <div class="feature-content p-4">
                                <div class="feature-content-inner">
                                    <h4 class="text-white">빨무3040룰</h4>
